    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutEmployeeModel(int id, [FromForm]EmployeeModel employeeModel)
        {
            ...
            if (employeeModel.ImageFile != null)
            {
                ...
                // Save the new image and update the ImageName field
                existingEmployee.ImageName = await SaveImage(employeeModel.ImageFile);
            }
        ...
        public async Task<string> SaveImage(IFormFile imageFile)
        {
            ...
            imageName = imageName + "-_-" +DateTime.Now.ToString("yymmssfff")+Path.GetExtension(imageFile.FileName);
